...
- **Run `/design-inspiration`** before any design or UI work — read every image in `.claude/design-inspiration/references/`, extract design principles, and apply them throughout. No exceptions.
